...
public class AuthService {
    ...
    public LoginResponse login(String email, String password) {
        ...
        return new LoginResponse(true, "Đăng nhập thành công", token, user.getId(), user.getUsername(), user.getFullName());
    }
    ...
    public SignupResponse signup(String username, String email, String password, String fullName) {
        ...
        try {
            if (!cognitoService.userExistsInCognito(email)) {
                ...
                System.out.println("✅ User " + email + " đã được đồng bộ lên Cognito");
            }
        } catch (Exception e) {
        ...
        return new SignupResponse(true, "Đăng ký thành công");
    }
